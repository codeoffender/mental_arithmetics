...
def generate_expression(level: int) -> Tuple[str, Tuple[int, int]]:
    ...
    Rules:
      - Mixed operators allowed, with standard precedence
      - Max operators per expression: level-dependent
      - Operand ranges depend on the operator immediately preceding them
      - Levels 1–2: division results in integers (exact)
      - Level 3: division may yield half-integers (denominator 2) in intermediate/final results
